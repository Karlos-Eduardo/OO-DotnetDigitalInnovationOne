...
namespace DIO.Series
{
    class Program
    {
		...
		{
			Console.WriteLine();
			Console.WriteLine("DIO Séries e Filmes ao seu dispor!!!");
			Console.WriteLine("Informe a opção desejada:");

			Console.WriteLine("1- Listar séries");
			Console.WriteLine("1.1- Listar filmes");
			Console.WriteLine("2- Inserir nova série");
			Console.WriteLine("2.1- Inserir novo filme");
			Console.WriteLine("3- Atualizar série");
			Console.WriteLine("3.1- Atualizar filme");
			Console.WriteLine("4- Excluir série");
			Console.WriteLine("4.1- Excluir filme");
			Console.WriteLine("5- Visualizar série");
			Console.WriteLine("5.1- Visualizar filme");
